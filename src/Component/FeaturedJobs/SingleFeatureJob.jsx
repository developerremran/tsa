...
import { addToDb } from '../Uilts/FakeDB';
...
const SingleFeatureJob = () => {
    ...
    return (
        <div className='my-simple-container'>
            <h2 className='text-3xl font-bold text-center mt-16'>Job Details</h2>
            <div className='md:flex gap-5 items-center'>
                ...
                <div className='lg:w-1/2 w-full sm:mt-5'>
                    <div className='bg-blue-100 px-5 py-3 rounded-md'>
